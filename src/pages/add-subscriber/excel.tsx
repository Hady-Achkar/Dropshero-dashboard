...
import {ToastContainer, toast, ToastContent, TypeOptions} from 'react-toastify'
...
const AddNewUserFromExcel = () => {
	...
	return (
		<>
			...
			{showModal ? (
				<div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-zinc-600/75">
